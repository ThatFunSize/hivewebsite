      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">The oldest team in Utah - and the best.</h2>
            <p className="text-xl text-gray-400">Our team is 13 years old and is one of the top teams in the world.</p>
          </div>
